...
#include "CharacterMemoryGetNode.generated.h"

/**
 * 
 */
UCLASS()
class VNMEDITOR_API UCharacterMemoryGetNode : public UVNMBaseNode
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY()
	FName CharacterMemoryValueId;

	UPROPERTY()
	EMemoryType Type;

	UPROPERTY(EditAnywhere, Category="Character Memory")
	bool bUsePinsForIds;
};
